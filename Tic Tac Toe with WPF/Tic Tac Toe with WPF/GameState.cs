...
using Tic_Tac_Toe_with_WPF;

namespace Tic_Tac_Toe_with_WPF
{
    public class GameState
    {
...

        {
            ...
            {
                winInfo = new WinInfo { Type = WinType.MainDiagonal, Number = r };
                return true;
            ...
            {
                winInfo = new WinInfo { Type = WinType.AntiDiagonal, Number = c };
                return true;
            }
            winInfo = null;
            return false;
